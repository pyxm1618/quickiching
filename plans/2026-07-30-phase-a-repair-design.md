...
Phase A does not add Better Auth, Waffo, PostgreSQL/Drizzle, Vercel Workflow, licensed classic text, or a third-party AI provider. Production configuration will reject startup when any of those capabilities would be required.
