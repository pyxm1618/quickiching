...
**Tech Stack:** Next.js 15, React 19, TypeScript, Zod, Vitest, Drizzle ORM, PostgreSQL, Better Auth, Waffo Pancake SDK/Webhook API, Vercel Workflow-compatible job boundary, structured AI provider boundary.
...
### Task 12: Waffo Pancake payment, Webhook Inbox, refund, and manual-review boundary
...
- [ ] Implement the Waffo SDK adapter without granting from return URLs.
