...
**Tech Stack:** Next.js 15, TypeScript, Drizzle ORM, Neon PostgreSQL, Better Auth, Waffo Pancake, Vercel Workflow, Vitest, Zod.
...
- [ ] Add Drizzle, PostgreSQL driver, Better Auth, Waffo Pancake SDK boundary, Workflow SDK, and validation dependencies at lockfile-pinned versions.
