...
export function CommercialReadingReportView({ report }: { report: CommercialReadingReport }) {
  return (
    <section className="mt-12 space-y-6" aria-labelledby="deep-reading-title">
      <div className="rounded-3xl border border-[var(--gold)]/30 bg-gradient-to-b from-[rgba(235,178,85,0.08)] to-transparent p-6 sm:p-10 shadow-2xl">
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-white/[0.08] pb-6">
          <div>
            <p className="mystic-kicker">AI 深度洞察报告 · 十模块结构化解读</p>
          ...
          <span className="inline-flex items-center rounded-full border border-[var(--gold)]/40 bg-[var(--gold)]/10 px-3.5 py-1 font-mono text-xs font-semibold text-[var(--gold-2)]">
            Verified Commercial Report
          </span>
        </div>

        {/* 1. 核心洞察摘要 */}
        <div className="mt-8 rounded-2xl border border-[var(--gold)]/25 bg-black/30 p-6">
          <p className="text-xs font-semibold uppercase tracking-widest text-[var(--gold-2)]">核心洞察摘要 · Core Summary</p>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-white/[0.08] bg-black/20 p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-[var(--cyan)]">当前所处阶段 · Current Stage</p>
            <p className="mt-3 text-sm leading-7 text-[var(--ink-2)] sm:text-base">
              {report.currentStage}
            </p>
          </div>
          <div className="rounded-2xl border border-white/[0.08] bg-black/20 p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-[var(--cyan)]">本卦格局推演 · Hexagram Pattern</p>
            <p className="mt-3 text-sm leading-7 text-[var(--ink-2)] sm:text-base">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-white/[0.08] bg-black/20 p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-[var(--gold-2)]">变爻动向机制 · Change Mechanism</p>
            <p className="mt-3 text-sm leading-7 text-[var(--ink-2)] sm:text-base">
              {report.changeMechanism}
            </p>
          </div>
          <div className="rounded-2xl border border-white/[0.08] bg-black/20 p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-[var(--gold-2)]">未来可能走向 · Possible Direction</p>
            <p className="mt-3 text-sm leading-7 text-[var(--ink-2)] sm:text-base">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-red-500/20 bg-red-950/10 p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-red-400">盲区与潜在阻碍 · Obstacles & Blind Spots</p>
            <p className="mt-3 text-sm leading-7 text-[var(--ink-2)] sm:text-base">
              {report.obstaclesAndBlindSpots}
            </p>
          </div>
          <div className="rounded-2xl border border-emerald-500/20 bg-emerald-950/10 p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-emerald-400">转机出现的关键条件 · Turning Conditions</p>
            <p className="mt-3 text-sm leading-7 text-[var(--ink-2)] sm:text-base">
        ...
        <div className="mt-6 rounded-2xl border border-[var(--gold)]/30 bg-[var(--gold)]/[0.04] p-6">
          <p className="text-xs font-semibold uppercase tracking-widest text-[var(--gold)]">针对性行动建议 · Action Direction</p>
        ...
        <div className="mt-6 rounded-2xl border border-white/[0.08] bg-black/20 p-6">
          <p className="text-xs font-semibold uppercase tracking-widest text-[var(--ink-3)]">不确定性与观察边界 · Uncertainty & Boundaries</p>
