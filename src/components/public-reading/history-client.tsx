...
export function HistoryClient({ showCloudBanner = false }: { showCloudBanner?: boolean }) {
      ...
      {showCloudBanner && (
        <div className="mb-7 rounded-2xl border border-[var(--gold)]/30 bg-[rgba(235,178,85,0.06)] p-5 text-sm leading-7 text-[var(--ink-2)] sm:p-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <Link href="/account" prefetch={false} className="mystic-button !py-2.5 !px-5 text-xs shrink-0 font-medium">
              Open My Account →
            </Link>
          </div>
        </div>
