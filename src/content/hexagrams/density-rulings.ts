...
const RULING_SEEDS = [
  ...
  ["en", 6, "below-3%", "Hexagram 6 keeps conflict grounded in evidence, positions, process, and an outcome that can be carried. The page-specific value is in de-escalating the argument structure, not in restating the conflict keyword inside each section."],
  ...
  ["en", 16, "below-3%", "Hexagram 16 distinguishes useful encouragement from excitement that skips preparation. The authored line and practical sections already show how momentum needs organization; additional keyword repetition would turn that distinction into a slogan."],
  ...
  ["en", 43, "below-3%", "Hexagram 43 is handled as public clarity with caution, not as a license for attack or a relationship verdict. The page's explicit no-aggression framing and changing-line detail already serve the intent; repetition would overstate the breakthrough theme."],
