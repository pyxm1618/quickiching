...
const FAQ = [
  ...
  ["Is the I Ching online reading free?", "Yes. The I Ching online reading is free across all four public casting methods, with no sign-in or payment required. An optional question interpreter is separate and is not required for the static reading."],
