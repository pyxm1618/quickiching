...
export default function PrivacyPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 sm:py-16">
      ...
      <p className="mt-4 text-sm leading-7 text-[var(--ink-2)]">When commercial account features are enabled and you sign in, Quick I Ching stores the account, casting state, entitlement and payment state needed to provide those features. Payment processing is handled securely by our third-party payment partner Waffo; Quick I Ching does not store raw payment card details. If a question is attached to an account reading, its text is stored server-side in encrypted form with versioned encryption keys. Paid deep-reading output, order records, and refund processing states are stored server-side to fulfill reading delivery, maintain credit balances, process eligible refunds, and prevent duplicate charging.</p>
      ...
      <h2 className="mt-10 font-display text-2xl font-medium">Question privacy and Deep Reading</h2>
      <p className="mt-4 text-sm leading-7 text-[var(--ink-2)]">Questions are optional for a free cast, capped, masked for session replay, and kept out of URLs, metadata, structured data, analytics events, and application logs. Free readings never send a question or cast to an AI provider. If paid Deep Reading is enabled and you request it with an available credit, the question frozen at cast time and the context you submit are encrypted and saved with an immutable snapshot; the snapshot, exact cast facts, and grounded I Ching source material are sent through Vercel AI Gateway to the configured model and reviewer. Providers may process or retain requests under their applicable controls and privacy terms. Do not enter unnecessary sensitive personal, health, legal, or financial information. If paid Deep Reading is not enabled, this processing does not occur.</p>
