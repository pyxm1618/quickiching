...
try {
  ...
  await run(bun, ["x", "vitest", "run", "--no-file-parallelism", "src/server/db/postgres.integration.test.ts", "src/server/db/cp3-generation.integration.test.ts", "src/server/db/cp3-upgrade.integration.test.ts", "src/server/db/cp5-core.integration.test.ts", "src/server/db/readings-postgres-idempotency.integration.test.ts", "src/server/generation/postgres-repository.integration.test.ts", "src/server/generation/deep-reading-service.integration.test.ts", "src/server/payments/postgres-repository.integration.test.ts", "src/server/payments/closeout-event-identity.integration.test.ts", "src/server/payments/outbox-dispatcher.integration.test.ts", "src/server/payments/refund-ordering.integration.test.ts", "src/server/payments/payment-provider-read-settlement.integration.test.ts", "src/server/refunds/postgres-refund-repository.integration.test.ts", "src/server/refunds/postgres-refund-dispatch-outcomes.integration.test.ts", "src/server/refunds/refund-settlement-core.integration.test.ts", "src/server/refunds/refund-webhook-settlement.integration.test.ts", "src/server/refunds/postgres-refund-reconciliation.integration.test.ts", "src/server/refunds/refund-concurrency.integration.test.ts", "src/server/reconcile/reconcile.integration.test.ts", "src/server/account/postgres-account.integration.test.ts", "src/server/cp5-remediation.integration.test.ts", "src/server/cp6-repair.integration.test.ts", "src/server/auth/better-auth.integration.test.ts", "src/server/auth/runtime.integration.test.ts"], {
    ...process.env,
